...
#Get regulatory network of RGBM
#=======================================================================================
...
write.table(net_df,paste0(outputpath,"/Adjacency_Matrix/",sample_name,"Final_Adjacency_Matrix_for_Viper.csv"),row.names=F,col.names=F,quote=F,sep = "\t")


#Create the regulons for downstream enrichment analysis for Viper
#====================================================================================
afile <- paste0(outputpath,"/Adjacency_Matrix/",sample_name,"Final_Adjacency_Matrix_for_Viper.csv")
...
save(DEgeneSets,file=paste0(outputpath,"/Adjacency_Matrix/",sample_name,"All_Diff_MR_Info_Viper_BC_NES_1.Rdata"))
...
#=================================================================================================
pdf(paste0(outputpath,"/Images/",sample_name,"Activity_Viper_BC_NES_1.pdf"),pointsize=9,height=10,width=10)
