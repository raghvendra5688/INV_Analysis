...
D <- D[,filter_samples];
jpeg(filename="../Results/Paper_Figures/Svgs_Jpgs/Supp_Figure_1.jpeg",width=900, height=480, units="px", pointsize=12)
...
pdf(paste0("../Results/Paper_Figures/Figure1/RNA_Seq_Figure_1A.pdf"),width=12,height=10,pointsize = 16)
par(bg="white")
...
pdf("../Results/Paper_Figures/Figure1/BLCA_TF_Activity_Figure_1D.pdf",width=12,height=12,pointsize=16)
par(bg="white")
...
#========================================================================================
pdf("../Results/Paper_Figures/Figure1/BLCA_GeneRanks_FGSEA_Figure_1E.pdf",pointsize=18,height = 10, width = 10)
par(bg="white")
par(fg="black",col.axis="black",col.main="black",col.lab="black", cex.main=2.0, cex = 2.5)
...
#=================================================================================================
pdf("../Results/Paper_Figures/Figure1/BLCA_TopMR_Activity_Figure_1F.pdf",height=10,width=12,pointsize=16)
par(bg="white")
par(fg="black",col.axis="black",col.main="black",col.lab="black", cex.main=2.0, cex = 2.5)
